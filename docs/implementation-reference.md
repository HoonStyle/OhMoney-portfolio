# OhMoney implementation reference

[Back to README](../README.md)

기존 구현 설명과 화면 자료를 보존한 참고 문서입니다. 아래 구조·코드 조각은 시스템 설명용이며 이 공개 저장소만으로 전체 서비스를 실행할 수 있다는 뜻이 아닙니다.
...
![Shorts Analytics](screenshots/shorts_analytics.png)

### Metrics Board

수익 지표, 전환율, CPA 등 캠페인 성과를 종합적으로 분석하는 지표 통합 보드.

![Metrics Board](screenshots/metrics_board.png)

### Generated Videos

생성된 영상 목록. 각 영상의 상태, 생성일, 조회수를 확인하고 상세 정보에 접근.

![Generated Videos](screenshots/generated_videos.png)
...
![Idea Bank](screenshots/idea_bank.png)
